...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* ── Header ── */
    .header { background: #D97706; color: #fff; padding: 24px 32px 28px; position: relative; }
    ...
    /* ── Demurrage card ── */
    .demurrage-card { background: #F3F4F6; border: 1px solid #D97706; border-radius: 10px; padding: 18px 20px; display: flex; align-items: center; justify-content: space-between; margin-bottom: 12px; }
    .demurrage-label { font-size: 0.7rem; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; color: #D97706; }
    .demurrage-ar { font-size: 0.75rem; color: #B45309; direction: rtl; font-family: 'Tahoma', Arial, sans-serif; margin-top: 2px; }
    .demurrage-amount { font-size: 2rem; font-weight: 800; color: #D97706; margin-top: 8px; }
    ...
    .breakdown-row.method { color: #374151; font-weight: 600; }
